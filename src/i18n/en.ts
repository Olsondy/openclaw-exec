...
export const en: Dict = {
  ...
  welcome: {
    ...
    licenseDesc: 'Enter a License Key to connect to the cloud OpenClaw service. Ideal for subscription users.',
    licenseHint: 'Configuration managed centrally by cloud after activation',
    localTitle: 'Connect Local Instance',
    localDesc: 'Auto-discover and connect to a locally installed OpenClaw. Ideal for self-hosted users.',
  ...
  localConnect: {
    ...
    errorMsg: 'Connection failed. Check the logs below, or restart the openclaw service manually and retry.',
  ...
  settings: {
    ...
    activateFirst: 'The current gateway is not connected and cannot be configured.',
